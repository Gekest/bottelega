  ...
  switch ($cmd){
    case 'create':
      ...
      <ol class="breadcrumb float-right">
        ...
        <li class="breadcrumb-item"><a href="subcategory.php?category=<?=$category;?>"><?=$cat['name'];?></a></li>
        <li class="breadcrumb-item"><a href="key.php?category=<?=$category;?>&subcategory=<?=$subcategory;?>"><?=$subcat['name'];?></a></li>
        <li class="breadcrumb-item">Добавление товара</li>
...
<button type="submit" name="create" class="btn btn-primary waves-effect w-md waves-light" data-loading-text="Добавляю">Добавить</button></form></div>';
...
<input type="file" placeholder="Фото" class="form-control" name="photo5">
      ...
      echo '<button type="submit" name="edit" class="btn btn-primary waves-effect w-md waves-light" data-loading-text="Изменить">Изменить</button></form></div>';
    ...
    case 'delete':
      ...
      <ol class="breadcrumb float-right">
        ...
        <li class="breadcrumb-item"><a href="subcategory.php?category=<?=$category;?>"><?=$cat['name'];?></a></li>
        <li class="breadcrumb-item"><a href="key.php?category=<?=$category;?>&subcategory=<?=$subcategory;?>"><?=$subcat['name'];?></a></li>
        <li class="breadcrumb-item">Удаление адреса: <b><?=$key_del['code'];?></b></li>
      </ol><div class="clearfix"></div></div></div></div>
    ...
    case 'remove_sale':
      ...
      <ol class="breadcrumb float-right">
        ...
        <li class="breadcrumb-item"><a href="subcategory.php?category=<?=$category;?>"><?=$cat['name'];?></a></li>
        <li class="breadcrumb-item"><a href="key.php?category=<?=$category;?>&subcategory=<?=$subcategory;?>"><?=$subcat['name'];?></a></li>
        <li class="breadcrumb-item">Удаление всех не проданных товаров</li>
      </ol><div class="clearfix"></div></div></div></div>
      <div class="alert alert-danger">Будут удалены все не проданные товары!</div>

      <div class="btn-group">
        <button type="button" class="btn btn-danger dropdown-toggle" data-loading-text="Думаем" data-toggle="dropdown">Вы уверены? <span class="caret"></span></button>
        <ul class="dropdown-menu" role="menu">
          <li><a href="?cmd=remove_sale&category=<?=$category;?>&subcategory=<?=$subcategory;?>&ok">Да, удалить все не проданные товары</a></li>
          <li class="divider"></li>
...
<ol class="breadcrumb float-right">
  ...
  <li class="breadcrumb-item"><a href="subcategory.php?category=<?=$category;?>"><?=$cat['name'];?></a></li>
  <li class="breadcrumb-item"><a href="key.php?category=<?=$category;?>&subcategory=<?=$subcategory;?>"><?=$subcat['name'];?></a></li>
  <li class="breadcrumb-item">Удаление товара: <b><?=$key_del['code'];?></b></li>
</ol><div class="clearfix"></div></div></div></div>
...
echo '<button type="button" class="btn btn-danger waves-effect w-md waves-light" id="custom-alert"> Удалить все не проданные адреса</button></div>';
echo '</div>';
}
        ...
        $('#custom-alert').click(function () {
            swal({
               ...
               confirmButtonClass: 'btn btn-success',
                ...
                confirmButtonText: '<a style="color: #ffffff;" href="key.php?cmd=remove_sale&category=<?=$category;?>&subcategory=<?=$subcategory;?>&ok">Да, удалить</a>!',
                cancelButtonText: '<a style="color: #ffffff;" href="key.php?category=<?=$category;?>&subcategory=<?=$subcategory;?>">Нет, отменить</a>',
				buttonsStyling: false
            }).then(function () {
                swal(
                    'Удалено!',
                    'удалены все не проданные товары!',
                    'success'
                )
            }, function (dismiss) {
