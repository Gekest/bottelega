...
<? if (isset($_COOKIE['secretkey']) or $_COOKIE['secretkey'] == $secretkey): ?>
    ...
    switch ($cmd){
        case 'edit':
            ...
            <form method="POST" action="?cmd=edit&chat=<?=intval($_GET['chat']);?>&ok">
                <div class="form-group col-sm-8">
                    ...
                    <button type="submit" name="submit" class="btn btn-danger btn btn-block" data-loading-text="Изменяю">Изменить</button></form>
            </div>
        ...
        default:
            ...
            ?>
            <ol class="breadcrumb float-right">
                <li class="breadcrumb-item" ><a class="breadcrumb-item"href="/admin"> Главная</a></li>
                <li class="breadcrumb-item">Курьеры</li>
            </ol><div class="clearfix"></div></div></div></div>
