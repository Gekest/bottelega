...
<ol class="breadcrumb float-right">
  ...
  <li class="breadcrumb-item">Проданные/не проданные товары</li>
...
<div class="list-group">
  ...
  <a class="list-group-item active">Не проданные товары</a>
</div>
...
<div class="list-group">
  ...
  <a href="?cmd=sale_null" class="list-group-item">Не проданные товары</a>
</div>
