...
<ol class="breadcrumb float-right">
  ...
  <li class="breadcrumb-item">Создание подкатегории</li>
</ol><div class="clearfix"></div></div></div></div>
<?
...
<input type="text" placeholder="Цена товара" class="form-control" name="amount">
</div><br />
<button type="submit" name="create" class="btn btn-primary waves-effect w-md waves-light" data-loading-text="Создаю">Создать</button></form>
</div>';
...
<ol class="breadcrumb float-right">
  <li class="breadcrumb-item"><a href="/admin"> Главная</a></li>
  <li class="breadcrumb-item"><a href="subcategory.php?category=<?=$category;?>"><?=$cat['name'];?></a></li>
  <li class="breadcrumb-item">Редактирование подкатегории</li>
</ol><div class="clearfix"></div></div></div></div>
<?	
...
<ol class="breadcrumb float-right">
  <li class="breadcrumb-item"><a href="/admin"> Главная</a></li>
  <li class="breadcrumb-item"><a href="subcategory.php?category=<?=$category;?>"><?=$cat['name'];?></a></li>
  <li class="breadcrumb-item">Удаление подкатегории: <b><?=$subcat['name'];?></b></li>
</ol><div class="clearfix"></div></div></div></div>
<div class="alert alert-danger">Будут удалены все товары из данной подкатегории!</div>
